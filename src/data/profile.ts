export const profileData = {
  ...
  experience: [
    {
      ...
      company: "Arts System's",
      period: "Nov/2025 - Jan/2026 (2 meses)",
      description: "Atuação no ecossistema PHP utilizando Laravel. Responsável por refatorar código legado, otimizar consultas, aplicar correções de bugs e auxiliar no desenvolvimento de novas funcionalidades para sistemas da empresa."
    }
  ],
  skills: {
  ...
  links: {
    ...
    email: "gaelleiteguzman@gmail.com",
  }
};